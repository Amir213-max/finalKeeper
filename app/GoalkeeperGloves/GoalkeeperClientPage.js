          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 p-2 sm:p-4">
            {currentProducts.map((product) => (
              ...
              >
                ...
                {/* ✅ Product Image Slider (fixed center, not affected by language) */}
          ...
          {totalPages > 1 && (
            <div className="flex flex-wrap justify-center items-center gap-2 mt-6">
              <button
                ...
                className="px-3 sm:px-4 py-2 rounded-lg bg-gray-200 text-gray-700 disabled:opacity-50 text-sm sm:text-base"
              >
                Prev
              </button>
